...
<body>
    ...
    <div class="container mt-4" style="max-width: 500px;">
        <form action="../functions/search_book_ISBN.php" method="post">
            <div class="form-group">
                <label for="ISBN">ISBN:</label>
                <input class="form-control" type="text" id="ISBN" name="ISBN" required>
            </div>
            <div class="form-group text-center">
                <input class="btn btn-primary btn-lg" type="submit" value="Serach by ISBN">
            </div>
        </form>

        <form action="../functions/search_book_title.php" method="post">
            <div class="form-group">
